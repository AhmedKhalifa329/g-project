                ...
                <div class="social-media">
                  <div class="col-lg-8">
                    <div class="d-flex justify-content-end pt-3">
                      <a class="btn btn-outline-secondary me-2 btn-md-square rounded-circle a-icon" href="">
                      ...
                      <a class="btn btn-outline-secondary btn-md-square rounded-circle a-icon" href="">
