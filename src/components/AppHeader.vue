      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav m-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link nav-link p-lg-3" aria-current="page"
              ><router-link to="/Prodects">Prodects</router-link></a
            >
          </li>
          <li class="nav-item">
            <a class="nav-link p-lg-3" aria-current="page"
              ><router-link to="/companies">Companies</router-link></a
            >
          </li>
          <li class="nav-item dropdown">
            <a
              class="nav-link dropdown-toggle nav-link p-lg-3"
              href="#"
              role="button"
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <a
                  class="nav-link nav-link p-lg-3 dropdown-item"
                  aria-current="page"
                  ><router-link to="/loginViwe">login Us</router-link></a
                >
              </li>
        ...
        <form class="d-flex" role="search">
          <input
            ...
            v-show="showy"
          />
          <font-awesome-icon icon="fa-search" class="icon" @click="showe" />
          <font-awesome-icon
            icon="fa-user"
            class="icon"
            @click="goToSingpage"
...
a {
  color: rgba(132, 129, 129, 0.976) !important ;
  transition: 0.5s;
