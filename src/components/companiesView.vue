...
<template>
  <div class="col-md-6 col-lg-4 col-xl-3">
    <div class="owl-item active" style="width: 260.25px; margin-right: 25px">
      <div
        class="border border-primary ap rounded position-relative company-item"
      ...
      >
        ...
        <div
          ...
          style="top: 10px; right: 10px; background-color: #81c408 !important"
        >
          company
        </div>
...
.company-item .company-img img:hover {
  transform: scale(1.3);
}
.rounded-bottom {
  height: 200px;
